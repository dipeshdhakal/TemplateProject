...
class KeychainWrapper {
    /// Singleton
    nonisolated(unsafe) static let `default` = KeychainWrapper()
    ...
    @discardableResult func removeObject(
        forKey key: String,
    ...
    @discardableResult private static func deleteKeychainSecClass(
